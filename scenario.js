...
(function () {
  ...
  const SCN = {
    normal: {
      ...
      trace: {
        action: 'ACTION #184',
        detected: '<b>GPU Cluster B</b> utilization reached 91%. Rack temperature variance exceeded the target range.',
        reasoning: 'If current workload placement continues, Zone B is projected to breach its thermal threshold within <b>14 minutes</b>. Region 4 has available GPU capacity and lower grid carbon intensity for the next 2-hour window.',
        response: 'Migrated <b>18%</b> of non-latency-critical training workload to Oregon. Deferred <b>7 batch jobs</b> to the next low-carbon window. Adjusted cooling setpoints across <b>12 racks</b>.',
        verified: 'Cooling load reduced by <b>11.6%</b>. Average PUE improved from 1.22 to <b>1.18</b>. Thermal headroom recovered.'
      },
      events: [
    ...
    lowcarbon: {
      ...
      trace: {
        action: 'ACTION #258',
        detected: 'Oregon grid carbon intensity dropped to <b>112 g/kWh</b> — a 2-hour low-carbon window opened.',
