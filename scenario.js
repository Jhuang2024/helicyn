  ...
  function runOptimization() {
    ...
    timeline([
      ...
      { at: 7000, fn: () => {
        ...
        // mark proposed recommendations as ready for operator review
        document.querySelectorAll('.demo-rec:not(.is-approved) .demo-rec__statebadge').forEach((b) => {
          b.className = 'demo-rec__statebadge control-badge control-badge--opt';
          b.innerHTML = '<span class="d"></span>Ready for review';
        });
