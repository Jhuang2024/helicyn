...
/** Facility power demand chart, fed by live simulation history. */
...
/** Cooling load per thermal zone, with expandable zone detail. */
export function CoolingZonesPanel() {
  const sim = useControlPlane((s) => s.sim);
...
/** Carbon / GPU / PUE trend charts fed by simulation history. */
...
/** Before/after optimization comparison bars (baseline → coordinated). */
