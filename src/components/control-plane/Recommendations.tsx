  ...
  return (
    ...
    >
      ...
      <div className="cp-rec__actions">
        ...
        <button type="button" className="cp-btn" onClick={onExplain} title="Open the reasoning and decision trace in the details panel">
          Explain
        </button>
      ...
      <div className="cp-deck">
        ...
        <div className="cp-ctrl">
          <span className="cp-ctrl__k">
            Customer guarantees
            <Tooltip
              label="About customer guarantees"
              text="A hard boundary: work with strict speed or deadline promises (service-level agreements) is never moved or slowed in a way that would break those promises."
            />
          </span>
          <span className="cp-locked mono">Always protected</span>
        </div>
        <div className="cp-ctrl">
          <span className="cp-ctrl__k">
            ...
            <Tooltip
              ...
              text="How much of the work is allowed to move or wait. More flexibility gives Helicyn more room to shift work toward cleaner, cheaper, cooler conditions."
            />
          ...
          <div className="cp-ctrl__scale mono">
            <span>Nothing moves</span>
            <span>Free to move</span>
          </div>
        </div>
        <Segmented
          ...
          tooltip="How close to temperature limits the system is allowed to run. Higher tolerance unlocks more savings but leaves less safety margin against hot spots."
        />
        <p className="cp-deck__explain">{MODE_EXPLAIN[controls.mode] + carbonText}</p>
        <p className="cp-deck__foot mono">Projections update in real time</p>
      </div>
    </div>
  );
}
