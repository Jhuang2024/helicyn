...
const NEW_ENTRY_HTML = `
      <article class="patchcard pglow-ring" data-reveal style="--i:0" data-tag="Product">
        <div class="patchcard__meta">
          <time class="mono patchcard__date" datetime="2026-07-13">July 13, 2026</time>
          ...
          <span class="mono patchcard__read">3 min read</span>
        </div>
        <h3 class="patchcard__title">React migration and interface refinement</h3>
        <ul class="patchcard__body">
          ...
          <li>Reworked the Control Plane around a calmer workspace hierarchy: roomier metric cards, plain-language navigation, a guided overview, a contextual inspector, and an event stream that stays collapsed until requested.</li>
          <li>Reduced toolbar complexity by keeping only live essentials visible, moving playback speed, manual time advancement, and scenario restart into a secondary controls menu, and renaming comparisons to "Original plan" and "Helicyn plan."</li>
          <li>Redesigned partner login as a focused access screen, removed magic-link and persistent-login controls, and isolated authentication fields from legacy form styles that caused narrow inputs, centered labels, and stray divider lines.</li>
          ...
          <li>Fixed clipped lowercase descenders on section headings (including "Eight signals, one board." and "From signal to verified action.") at the root, using a shared, descender-safe heading and reveal system, and audited every other heading and route for the same problem.</li>
          ...
          <li>Standardized punctuation across source, tests, documentation, and legacy assets so the repository no longer contains em dashes.</li>
